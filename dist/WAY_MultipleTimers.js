...
(function ($) {
  ...
  Game_Timer.prototype.createTimer = function (id, onExpire) {
    if (this._timers[id] === undefined) {
      ...
      console.error("WAY_MultipleTimers: Timer with id ".concat(id, " is already defined!"));
    }
  }; // TODO: Add drawing
  ...
  Game_Timer.prototype.update = function (sceneActive) {
    ...
    this._timers.forEach(function (current) {
  ...
  PluginManager.addCommand("Timer", {
    createTimer: function createTimer(id, onExpire) {
      $gameTimer.createTimer(id, onExpire);
    },
    startTimer: function startTimer(id, count) {
