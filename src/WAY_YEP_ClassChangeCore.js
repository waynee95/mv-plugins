...
($ => {
  const { classChangeCommand, classChangeCooldown } = $.parameters;
  ...
  // Window_ActorCommand
  //==========================================================================
  $.alias.Window_ActorCommand_makeCommandList =
  ...
  // Scene_Battle
  //==========================================================================
  $.alias.Scene_Battle_createActorCommandWindow =
