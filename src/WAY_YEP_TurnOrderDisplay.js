...
($ => {
  ...
  // Game_Enemy
  //==========================================================================
  $.alias.Game_Enemy_turnOrderDisplayBitmap =
    Game_Enemy.prototype.turnOrderDisplayBitmap;
  ...
  //==========================================================================
  $.alias.Window_TurnOrderIcon_drawBattler =
    Window_TurnOrderIcon.prototype.drawBattler;
